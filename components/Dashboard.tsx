...
export const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    // Atualizado para coleção 'cliente'
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Painel Analítico</h1>
          <p className="text-slate-500">Acompanhamento em tempo real da JPS Steel.</p>
        </div>
      </div>
